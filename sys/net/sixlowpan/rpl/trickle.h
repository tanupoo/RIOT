...
#define TRICKLE_TIMER_STACKSIZE 3072*10240
#define TRICKLE_INTERVAL_STACKSIZE 3072*10240
#define DAO_DELAY_STACKSIZE 3072*10240
#define RT_STACKSIZE 512*10240
