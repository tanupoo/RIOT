...
#if ENABLE_DEBUG
    #define ETX_BEACON_STACKSIZE    (4500*10240)
    #define ETX_RADIO_STACKSIZE     (4500*10240)
    #define ETX_CLOCK_STACKSIZE      (500*10240)
#else
    #define ETX_BEACON_STACKSIZE    (2500*10240) //TODO optimize, maybe 2000 is enough
    #define ETX_RADIO_STACKSIZE     (2500*10240) //TODO optimize, maybe 2000 is enough
    #define ETX_CLOCK_STACKSIZE      (500*10240) //TODO optimize, maybe  250 is enough
#endif
