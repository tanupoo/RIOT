...
#define GPIO_IRQ_8          GPIO_4
#define GPIO_IRQ_9          GPIO_7
...
#define GPIO_1_PORT         GPIOB                   /* user pin 2, DO NOT USE AS EXTI  */
#define GPIO_1_PIN          9
...
#define GPIO_3_PORT         GPIOC                   /* user button */
#define GPIO_3_PIN          13
#define GPIO_3_CLKEN()      (RCC->APB2ENR |= RCC_APB2ENR_IOPCEN)
#define GPIO_3_EXTI_CFG()   (AFIO->EXTICR[3] |= AFIO_EXTICR4_EXTI13_PC)
#define GPIO_3_IRQ          EXTI15_10_IRQn
/* GPIO channel 4 config */
#define GPIO_4_PORT         GPIOB                   /* l3g4200d: int2/drdy */
#define GPIO_4_PIN          8
#define GPIO_4_CLKEN()      (RCC->APB2ENR |= RCC_APB2ENR_IOPBEN)
#define GPIO_4_EXTI_CFG()   (AFIO->EXTICR[2] |= AFIO_EXTICR3_EXTI8_PB)
#define GPIO_4_IRQ          EXTI0_IRQn
/* GPIO channel 5 config */
#define GPIO_5_PORT         GPIOB                   /* lsm303dlhc: int1, DO NOT USE AS EXTI */
#define GPIO_5_PIN          9
#define GPIO_5_CLKEN()      (RCC->APB2ENR |= RCC_APB2ENR_IOPBEN)
#define GPIO_5_EXTI_CFG()   (AFIO->EXTICR[2] |= AFIO_EXTICR3_EXTI9_PB)
...
#define GPIO_6_EXTI_CFG()   (AFIO->EXTICR[1] |= AFIO_EXTICR2_EXTI5_PB)
#define GPIO_6_IRQ          EXTI9_5_IRQn
/* GPIO channel 7 config */
#define GPIO_7_PORT         GPIOA                   /* lsm303dlhc: drdy */
#define GPIO_7_PIN          9
#define GPIO_7_CLKEN()      (RCC->APB2ENR |= RCC_APB2ENR_IOPAEN)
#define GPIO_7_EXTI_CFG()   (AFIO->EXTICR[2] |= AFIO_EXTICR3_EXTI9_PA)
...
#define GPIO_11_EXTI_CFG()  (AFIO->EXTICR[1] |= AFIO_EXTICR1_EXTI1_PA)
#define GPIO_11_EXTI_LINE   1
