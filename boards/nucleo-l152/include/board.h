...
/**
 * @defgroup    board_nucelo_l152 nucelo_l152
 * @ingroup     boards
 * @brief       Board specific files for the nucelo_l152 board
 * @{
 *
 * @file
 * @brief       Board specific definitions for the nucelo_l152 evaluation board
 *
