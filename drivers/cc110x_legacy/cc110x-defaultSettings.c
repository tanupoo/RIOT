...
char cc110x_conf[] = {
  ...
  0x9B, // SYNC1
  0xAD, // SYNC0
  0xFF, // PKTLEN 		(maximum value of packet length byte = 61)
  0x04, // PKTCTRL1
  0x05, // PKTCTRL0 	(variable packet length) 
  0xFF, // ADDR
  CC1100_DEFAULT_CHANNR*10, // CHANNR
  0x0A, // FSCTRL1
  0x00, // FSCTRL0
  ...
  0x1C, // BSCFG
  0xC7, // AGCCTRL2
  0x00, // AGCCTRL1, (old value was 0x49 -> made carrier sense less sensitive!)
        //            0x47 - 7 dB above MAGN_TARGET setting
  0xB0, // AGCCTRL0
  0x87, // WOREVT1
  0x6B, // WOREVT0
